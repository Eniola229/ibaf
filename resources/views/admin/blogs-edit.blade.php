        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="card-style mb-30">
              ...
              <div class="input-style-1">
                ...
                <input type="text" name="title" value="{{ old('title', $blog->title) }}" placeholder="Enter blog title" required />
          ...
          <div class="col-lg-6">
            ...
            <div class="card-style mb-30">
              ...
              <div class="input-style-1">
                ...
                <textarea id="description" name="content" rows="6" placeholder="Enter blog content...">{{ old('content', $blog->content) }}</textarea>
          ...
          <div class="card-style mb-30">
            ...
            <div class="input-style-1">
              ...
              @if ($blog->cover_image)
                <div class="mt-2">
                  <img src="{{ $blog->cover_image }}" alt="Current Cover" class="img-thumbnail" style="max-height: 150px;">
                </div>
              @endif
        ...
        <div class="row">
          <div class="col-12 text-end">
            <button type="submit" class="btn btn-success">
              <i class="lni lni-save"></i> Update Blog
            </button>
          </div>
        </div>
      </form>
