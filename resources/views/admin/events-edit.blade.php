                  ...
                  <div class="row">
                          ...
                          <div class="card-style mb-30">
                              ...
                              <div class="input-style-1">
                                  ...
                                  <textarea id="description" name="description" rows="6" 
                                      placeholder="Enter event details..." required>{{ old('description', $event->description) }}</textarea>
                      ...
                      <div class="card-style mb-30">
                          ...
                          @if($event->cover_image)
                              <div class="mt-2">
                                  <img src="{{ $event->cover_image }}" alt="Cover Image" class="img-thumbnail" width="200">
                  ...
                  <div class="row">
                      <div class="col-12 text-end">
                          <button type="submit" class="btn btn-success">
                              <i class="lni lni-checkmark"></i> Update Event
                          </button>
                      </div>
                  </div>
              </form>
